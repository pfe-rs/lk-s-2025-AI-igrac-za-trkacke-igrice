...
from modelArh import CarGameAgentDoubleMaybe  # Your custom model
...
for epoch in range(epochs):
    ...
    if epoch%30==0:
        torch.save(gb_model.state_dict(), f"models_supervised_maybe/gas_brake_model{gen+10+epoch}.pkl")
        torch.save(lr_model.state_dict(), f"models_supervised_maybe/steer_model{gen+10+epoch}.pkl")
